'''
In this file, we manage the timer menu for multiplayer chess.
'''
import pygame

from extras.loader import TIMER, BACK, putLargeNum
from extras.utilities import roundedRectangle

# This shows the initial prompt message
def start(win, load):
    roundedRectangle(win, (255, 255, 255), (120, 180, 260, 100), 10, 4)
...
def showScreen(win, sel, sel2):
    ...
    roundedRectangle(win, (255, 255, 255), (10, 70, 480, 420), 12, 4)
